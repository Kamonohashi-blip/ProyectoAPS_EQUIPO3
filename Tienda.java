...
public class Tienda extends javax.swing.JFrame {
    ...
    private String[] Encabezado1 = {"Código", "Nombre del Producto", "Precio Unitario"};
    private String[] Encabezado2 = {"Código", "Nombre del Producto", "Cantidad", "Precio Unitario"};
    ...
    private void initComponents() {
        ...
        setTitle("Tienda El Sol Naciente");
        ...
        AddProducto.setFont(new java.awt.Font("Agency FB", 1, 18)); // NOI18N
        AddProducto.setText("Adicionar Producto");
        ...
        Tabla2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Titulo", "Cantidad", "Precio Unitario"
            }
        ) {
            boolean[] canEdit = new boolean [] {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addComponent(AddProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(AddProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void ComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComprarActionPerformed
        ...
        if(s==-1) 
           JOptionPane.showMessageDialog(this, "Seleccione el producto que desea comprar."); 
        else{
            int pos = buscarEnCarrito(s);
            if( pos != -1 ) {
                String cantidad = JOptionPane.showInputDialog("Ya se ha adquirido este producto. Ingrese la nueva cantidad que desea adquirir:");
            ...
            fila[0] = modelo1.getValueAt(s, 0); // Codigo.
    ...
    private int buscarEnCarrito(int s) {
        String Codigo = (String) modelo1.getValueAt(s, 0);
        String Nombre = (String) modelo1.getValueAt(s, 1);
        
        for(int i=0; i<modelo2.getRowCount(); ++i) {
            @SuppressWarnings("UseOfObsoleteCollectionType")
            Vector v = (Vector) modelo2.getDataVector().get(i);
            if(v.get(0).equals(Codigo) && v.get(1).equals(Nombre))
                return i;
        }
        return -1;        
    }
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        if( existeProducto(Codigo, Nombre) ) 
    ...
    private boolean existeProducto(String Codigo, String Nombre) {
